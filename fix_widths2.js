...
fs.copyFileSync('Cetak Formulir Pendaftar PAB 2026.docx', 'apps/web/public/Cetak Formulir Pendaftar PAB 2026.docx');

['apps/web/public/Cetak Formulir Pendaftar PAB 2026.docx'].forEach(path => {
  try {
    ...
    // Fix date
    xml = xml.replace('6/15/26,', '{waktu_cetak}').replace('10:54 PM', '');
